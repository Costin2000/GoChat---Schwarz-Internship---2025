...
const (
	GatewayService_Ping_FullMethodName = "/gateway.GatewayService/Ping"
)
...
type GatewayServiceClient interface {
	Ping(ctx context.Context, in *proto.Empty, opts ...grpc.CallOption) (*proto.Pong, error)
}
...
func (c *gatewayServiceClient) Ping(ctx context.Context, in *proto.Empty, opts ...grpc.CallOption) (*proto.Pong, error) {
...
type GatewayServiceServer interface {
	Ping(context.Context, *proto.Empty) (*proto.Pong, error)
...
func (UnimplementedGatewayServiceServer) Ping(context.Context, *proto.Empty) (*proto.Pong, error) {
...
func _GatewayService_Ping_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GatewayServiceServer).Ping(ctx, req.(*proto.Empty))
	}
