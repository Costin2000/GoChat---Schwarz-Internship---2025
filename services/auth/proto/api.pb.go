...
const file_api_proto_rawDesc = "" +
	"\n" +
	"\tapi.proto\x12\x04auth\"\a\n" +
	"\x05Empty\" \n" +
	"\x04Pong\x12\x18\n" +
	"\amessage\x18\x01 \x01(\tR\amessage2.\n" +
	"\vAuthService\x12\x1f\n" +
	"\x04Ping\x12\v.auth.Empty\x1a\n" +
	".auth.PongBSZQhttps://github.com/Costin2000/GoChat---Schwarz-Internship---2025/auth/proto;protob\x06proto3"
...
var file_api_proto_goTypes = []any{
	...
	(*Pong)(nil),  // 1: auth.Pong
}
var file_api_proto_depIdxs = []int32{
	0, // 0: auth.AuthService.Ping:input_type -> auth.Empty
	1, // 1: auth.AuthService.Ping:output_type -> auth.Pong
