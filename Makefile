...
SERVICES := services/api-rest-gateway services/auth services/friend-request-base services/user-base services/aggregator services/email services/message-base services/conversation-base
